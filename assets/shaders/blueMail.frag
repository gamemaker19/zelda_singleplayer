...
float4 ps_main(VS_OUTPUT Input) : COLOR0
{
   ...
   float3 replaceColor = float3(0/255.0f,96/255.0f,208/255.0f);
   float3 origColor2 = float3(64/255.0f,216/255.0f,112/255.0f);
   float3 replaceColor2 = float3(136/255.0f,160/255.0f,232/255.0f);
   float3 origColor3 = float3(80/255.0f,144/255.0f,16/255.0f);
   float3 replaceColor3 = float3(192/255.0f,168/255.0f,72/255.0f);
   float3 origColor4 = float3(120/255.0f,184/255.0f,32/255.0f);
   float3 replaceColor4 = float3(248/255.0f,216/255.0f,128/255.0f);
